...
const Extra = () => {
  ...
  useEffect(() => {
    ...
    setCartItems(cartData.forSale.commercial.showroom);
  }, []);
  ...
  return (
    <div>
      <section className="relative">
        <img
          src="https://www.dhamuandcompany.net/wp-content/uploads/2019/08/showroom-banner-jaipur.jpg"
          alt="Villa for Sale"
      ...
      <section className="">
        <div className="md:m-12 m-3">
          <p className="bg-blue-950 text-white md:w-48 w-40 p-2 md:text-xl">Showroom For Sale</p>
          <div className="md:p-5 p-2 border">
            <p className="text-blue-950 md:text-lg font-medium">Check Showroom for Sale in Jaipur</p>
            <ul className="md:pt-5 pt-2 font-light text-md">
              <li className="pb-1">✔ Showroom in High Street</li>
              <li className="pb-1">✔ Showroom in Mall</li>
              <li className="pb-1">✔ Assured Rental Showroom</li>
              <li className="pb-1">✔ Showroom in Commercial Building</li>
