...
const Extra = () => {
  ...
  useEffect(() => {
    ...
    setCartItems(cartData.forRent.commercial.Warehouse);
  }, []);
  ...
  return (
    <div>
      <section className="relative">
        <img
          src="https://www.dhamuandcompany.net/wp-content/uploads/2020/04/warehouse-in-jaipur.jpg"
          alt="Villa for Sale"
      ...
      <section className="">
        <div className="md:m-12 m-3">
          <p className="bg-blue-950 text-white md:w-64 w-52 p-2 md:text-xl">Warehouse for Rent

          </p>
          <div className="md:p-5 p-2 border">
          <p className="text-blue-950 md:text-lg font-medium">Check Warehouse For Rent in Jaipur</p>
            <ul className="md:pt-5 pt-2 font-light text-md">
              <li className="pb-1">✔ JdA Approved Warehouse for Rent</li>
              <li className="pb-1">✔ Built to Suit Warehouse for Rent Jaipur</li>
              <li className="pb-1">✔ Warehouse For Rent in Bagru Industrial Area</li>
              <li className="pb-1">✔ Warehouse For Rent in VKI Industrial Area</li>
              <li className="pb-1">✔ Warehouse For Rent in Sitapura Industrial Area</li>
              <li className="pb-1">✔ Warehouse For Rent in Mansrovar Industrial Area</li>
