...
const Extra = () => {
  ...
  useEffect(() => {
    ...
    setCartItems(cartData.forSale.residential.residentialPlot);
  }, []);
    ...
    <div>
      <section className="relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          Residential Plot for Sale in Jaipur
          </span>
        </div>
      </section>
      ...
      <section className="">
        <div className="md:m-12 m-3">
          <p className="bg-blue-950 text-white md:w-64 w-52 p-2 md:text-xl">Residential Plot For Sale
          </p>
