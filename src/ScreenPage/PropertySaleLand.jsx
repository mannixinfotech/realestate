...
const Extra = () => {
  ...
  useEffect(() => {
    ...
    setCartItems(cartData.forSale.commercial.commercialLand);
  }, []);
    ...
    <div>
      <section className="relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          Commercial Land for Sale in Jaipur | Commercial Plot in Jaipur
          </span>
        </div>
      </section>
      ...
      <section className="">
        <div className="md:m-12 m-3">
          <p className="bg-blue-950 text-white md:w-64 w-52 p-2 md:text-xl">Commercial Land for Sale</p>
          <div className="md:p-5 p-2 border">
            ...
            <ul className="md:pt-5 pt-2 font-light text-md">
              <li className="pb-1">✔ Land for Commercial Building</li>
              <li className="pb-1">✔ Land for Mall</li>
              <li className="pb-1">✔ Land for Office Building</li>
              <li className="pb-1">✔ Land for School</li>
              <li className="pb-1">✔ Land for Hospital</li>
              <li className="pb-1">✔ Land for Industry</li>
              <li className="pb-1">✔ Land for Warehouse / Godown</li>
              </ul>
