...
const Extra = () => {
  ...
  useEffect(() => {
    ...
    setCartItems(cartData.forSale.commercial.warehouse);
  }, []);
  ...
  return (
    <div>
      <section className="relative">
        <img
          src="https://www.dhamuandcompany.net/wp-content/uploads/2020/04/industrial-land-for-sale-in-jaipur-1.jpg"
          alt="Villa for Sale"
      ...
      <section className="">
        <div className="md:m-12 m-3">
          <p className="bg-blue-950 text-white md:w-64 w-52 p-2 md:text-xl">Warehouse for Sale</p>
          <div className="md:p-5 p-2 border">
            <p className="text-blue-950 md:text-lg font-medium">Check Warehouse For Sale in Jaipur</p>
            <ul className="md:pt-5 pt-2 font-light text-md">
              <li className="pb-1">✔ JdA Approved Warehouse for Sale</li>
              <li className="pb-1">✔ Built to Suit Warehouse for Sale Jaipur</li>
              <li className="pb-1">✔ Warehouse For Sale in Bagru Industrial Area</li>
              <li className="pb-1">✔ Warehouse For Sale in VKI Industrial Area</li>
              <li className="pb-1">✔ Warehouse For Sale in Sitapura Industrial Area</li>
              <li className="pb-1">✔ Warehouse For Sale in Mansrovar Industrial Area</li>
