...
const Extra = () => {
  ...
  useEffect(() => {
    ...
    setCartItems(cartData.forRent.commercial.SpaceForInstitute);
  }, []);
    ...
    <div>
      <section className="relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          Property For Rent for Institute / IT Company
          </span>
        </div>
      </section>
      ...
      <section className="">
        <div className="md:m-12 m-3">
          <p className="bg-blue-950 text-white md:w-96 w-80 p-2 md:text-xl">Space on Rent for Institute / IT Company

          </p>
          <div className="md:p-5 p-2 border">
            <p className="text-blue-950 md:text-lg font-medium">Check Property for Rent for Institute / IT Company</p>
            <ul className="md:pt-5 pt-2 font-light text-md">
              <li className="pb-1">✔ Furnished Office space for IT Company</li>
              <li className="pb-1">✔ Property for Rent in Coaching Institute</li>
