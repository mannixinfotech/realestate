...
const Extra = () => {
  ...
  useEffect(() => {
    ...
    setCartItems(cartData.forSale.commercial.shop);
  }, []);
    ...
    <div>
      ...
      <section className="">
        <div className="md:m-12 m-3">
          <p className="bg-blue-950 text-white md:w-36 w-32 p-2 md:text-xl">Shop For Sale</p>
          <div className="md:p-5 p-2 border">
            <p className="text-blue-950 md:text-lg font-medium">Check Shop for Sale in Jaipur</p>
            <ul className="md:pt-5 pt-2 font-light text-md">
              <li className="pb-1">✔ Shop in High Street</li>
              <li className="pb-1">✔ Shop in Mall</li>
              <li className="pb-1">✔ Assured Rental Shop</li>
              <li className="pb-1">✔ Shop in Commercial Building</li>
