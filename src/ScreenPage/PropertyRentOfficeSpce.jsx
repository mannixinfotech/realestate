...
const Extra = () => {
  ...
  // Set initial cart items on component load
  useEffect(() => {
    setCartItems(cartData.forRent.commercial.officeSpace);
  }, []);
  ...
  return (
    <div>
      <section className="relative">
        <img
          src="https://www.dhamuandcompany.net/wp-content/uploads/2017/09/office-space-in-jaipur-banner.jpg"
          alt="Villa for Sale"
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          Office Space For Rent in Jaipur
          </span>
        </div>
      </section>
      ...
      <section className="">
        <div className="md:m-12 m-3">
          <p className="bg-blue-950 text-white md:w-64 w-52 p-2 md:text-xl">Office for Rent

          </p>
          <div className="md:p-5 p-2 border">
            <p className="text-blue-950 md:text-lg font-medium">Check Office Space For Rent in Jaipur</p>
            <ul className="md:pt-5 pt-2 font-light text-md">
              <li className="pb-1">✔ Furnished Office Space for Rent in Jaipur</li>
              <li className="pb-1">✔ Office Space for IT Company</li>
              <li className="pb-1">✔ Office Space For Rent in Jaipur</li>
              <li className="pb-1">✔ Showroom For Rent in Jaipur</li>
              <li className="pb-1">✔ Shop for For Rent in Jaipur</li>
              <li className="pb-1">✔ Restaurant For Rent in Jaipur</li>
              <li className="pb-1">✔ Industrial Land for Rent in Jaipur</li>
              <li className="pb-1">✔ Warehouse for Rent in Jaipur</li>
