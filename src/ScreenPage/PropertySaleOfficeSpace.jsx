...
const Extra = () => {
  ...
  useEffect(() => {
    ...
    setCartItems(cartData.forSale.commercial.officeSpace);
  }, []);
    ...
    <div>
      ...
      <section className="">
        <div className="md:m-12 m-3">
          <p className="bg-blue-950 text-white md:w-48 w-40 p-2 md:text-xl">Office for Sale</p>
          <div className="md:p-5 p-2 border">
            <p className="text-blue-950 md:text-lg font-medium">Check Office Space For Sale in Jaipur</p>
            <ul className="md:pt-5 pt-2 font-light text-md">
              <li className="pb-1">✔ Office Space For Sale in Jaipur</li>
              <li className="pb-1">✔ Furnished Office Space for Sale in Jaipur</li>
