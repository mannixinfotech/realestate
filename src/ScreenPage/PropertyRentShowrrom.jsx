...
const Extra = () => {
  ...
  useEffect(() => {
    ...
    setCartItems(cartData.forRent.commercial.showroom);
  }, []);
    ...
    <div>
      ...
      <section className="">
        <div className="md:m-12 m-3">
          <p className="bg-blue-950 text-white md:w-64 w-52 p-2 md:text-xl">Showroom For Rent

          </p>
          <div className="md:p-5 p-2 border">
            <p className="text-blue-950 md:text-lg font-medium">Check Showroom for Rent in Jaipur</p>
