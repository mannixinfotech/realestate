...
const Extra = () => {
  ...
  useEffect(() => {
    ...
    setCartItems(cartData.forSale.commercial.restaurantSpace);
  }, []);
    ...
    <div>
      ...
      <section className="">
        <div className="md:m-12 m-3">
          <p className="bg-blue-950 text-white md:w-64 w-52 p-2 md:text-xl">Restaurant for Sale</p>
          <div className="md:p-5 p-2 border">
            <p className="text-blue-950 md:text-lg font-medium">Check Restaurant For Sale in Jaipur</p>
            <ul className="md:pt-5 pt-2 font-light text-md">
              ...
              <li className="pb-1">✔ Furnished Restaurant Space for Sale in Jaipur</li>
