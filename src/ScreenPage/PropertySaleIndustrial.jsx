...
const Extra = () => {
  ...
  useEffect(() => {
    ...
    setCartItems(cartData.forSale.commercial.industrialLand);
  }, []);
    ...
    <div>
      <section className="relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          Industrial Land For Sale In Jaipur
          </span>
        </div>
      </section>
      ...
      <section className="">
        <div className="md:m-12 m-3">
          <p className="bg-blue-950 text-white md:w-64 w-52 p-2 md:text-xl">Industrial Land For Sale</p>
          <div className="md:p-5 p-2 border">
            <p className="text-blue-950 md:text-lg font-medium">Check Commercial Land For Sale in Jaipur</p>
            <ul className="md:pt-5 pt-2 font-light text-md">
              <li className="pb-1">✔ JdA Apporoved Industrial Land</li>
              <li className="pb-1">✔ Industrial Land for Sale in Bagru Industrial Area</li>
              <li className="pb-1">✔ Industrial Land for Sale in VKI Industrial Areag</li>
              <li className="pb-1">✔ Industrial Land for Sale in Sitapura Industrial Area</li>
              <li className="pb-1">✔ Industrial Land for Sale in Mansrovar Industrial Area</li>
