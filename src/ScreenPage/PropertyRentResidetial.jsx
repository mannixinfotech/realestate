...
const Extra = () => {
  ...
  useEffect(() => {
    ...
    setCartItems(cartData.forRent.residential);
  }, []);
    ...
    <div>
      <section className="relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          Residential Property for Rent in Jaipur
          </span>
        </div>
      </section>
      ...
      <section className="">
        <div className="md:m-12 m-3">
          <p className="bg-blue-950 text-white md:w-96 w-80 p-2 md:text-xl">Residential Property for Rent

          </p>
          <div className="md:p-5 p-2 border">
            <p className="text-blue-950 md:text-lg font-medium">Check the Residential Property For Rent in Jaipur</p>
            <ul className="md:pt-5 pt-2 font-light text-md">
              <li className="pb-1">✔ Villa | Independent House for Rent in Jaipur</li>
              <li className="pb-1">✔ Apartment / Flat for Rent in Jaipur</li>
              <li className="pb-1">✔ Farm House For Rent in Jaipur</li>
              <li className="pb-1">✔ Builder Floor | Independent Floor for Rent in Jaipur</li>
