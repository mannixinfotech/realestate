...
const Extra = () => {
  ...
  useEffect(() => {
    ...
    setCartItems(cartData.forSale.residential.builderFloor);
  }, []);
  ...
  return (
    <div>
      <section className="relative">
        <img
          src="https://www.dhamuandcompany.net/wp-content/uploads/2020/04/builder-floor-for-sale-in-jaipur-banner.jpg"
          alt="Villa for Sale"
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          Builder Floor For Sale In Jaipur
          </span>
        </div>
      </section>
      ...
      <section className="">
        <div className="md:m-12 m-3">
          <p className="bg-blue-950 text-white md:w-64 w-52 p-2 md:text-xl">Builder Floor For Sale
          </p>
          <div className="md:p-5 p-2 border">
            <p className="text-blue-950 md:text-lg font-medium">Check Builder Floor For Sale in Jaipur</p>
            <ul className="md:pt-5 pt-2 font-light text-md">
              <li className="pb-1">✔ Builder Floor for Sale in Jaipur</li>
              <li className="pb-1">✔ Independent Floor for Sale in Jaipur
              </li>
